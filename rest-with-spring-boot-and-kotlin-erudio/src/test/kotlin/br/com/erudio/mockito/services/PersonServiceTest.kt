...
class PersonServiceTest {
    ...
    fun setUpMock() {
        ...
        MockitoAnnotations.openMocks(this)//carregando as instancias nesta classe
    }
...
//        System.out.println(result.links)
    ...
    fun createNullPerson() {
        ...
        val expectedMessge="It's not allowed to persist a null object!"
        val actualMessge=exception.message

        assertTrue(actualMessge!!.contains(expectedMessge))
    }
